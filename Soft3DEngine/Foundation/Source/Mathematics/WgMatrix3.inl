...
//----------------------------------------------------------------------------
template <class Real>
Matrix3<Real> Matrix3<Real>::Rotation(Real &xRotAng,Real &yRotAng,Real &zRotAng )
{
	Matrix3<Real> CalcMat3;
	Real Cx, Sx;
	Sx = Math<Real>::Sin(xRotAng);
	Cx = Math<Real>::Cos(xRotAng);
	Real Cy, Sy;
	Sy = Math<Real>::Sin(yRotAng);
	Cy = Math<Real>::Cos(yRotAng);

	Real Cz, Sz;
	Sz = Math<Real>::Sin(zRotAng);
	Cz = Math<Real>::Cos(zRotAng);
	...
	return Matrix3<Real>(CalcMat3);
}
//----------------------------------------------------------------------------
template <class Real>
Matrix3<Real> Matrix3<Real>::RotationX(Real &rkAngle )
{
	Matrix3<Real> CalcMat3;
	Real sintheta, costheta;
	sintheta = Math<Real>::Sin(rkAngle);
	costheta = Math<Real>::Cos(rkAngle);
	
	CalcMat3.m_afEntry[0] = (Real)1.0;
	CalcMat3.m_afEntry[3] = (Real)0.0;
	CalcMat3.m_afEntry[6] = (Real)0.0;
	CalcMat3.m_afEntry[1] = (Real)0.0;
	CalcMat3.m_afEntry[4] = costheta;
	CalcMat3.m_afEntry[7] = sintheta;
	CalcMat3.m_afEntry[2] = (Real)0.0;
...
//----------------------------------------------------------------------------
template <class Real>
Matrix3<Real> Matrix3<Real>::RotationY(Real &rkAngle )
{
	Matrix3<Real> CalcMat3;
	Real sintheta, costheta;
	sintheta = Math<Real>::Sin(rkAngle);
	...
	CalcMat3.m_afEntry[1] = (Real)0.0;
	CalcMat3.m_afEntry[4] = (Real)1.0;
	CalcMat3.m_afEntry[7] = (Real)0.0;
	CalcMat3.m_afEntry[2] = sintheta;
	CalcMat3.m_afEntry[5] = (Real)0.0;
	CalcMat3.m_afEntry[8] = costheta;
	return Matrix3<Real>(CalcMat3);
}
//----------------------------------------------------------------------------
template <class Real>
Matrix3<Real> Matrix3<Real>::RotationZ(Real &rkAngle )
{
	Matrix3<Real> CalcMat3;
	...
	CalcMat3.m_afEntry[2] = (Real)0.0;
	CalcMat3.m_afEntry[5] = (Real)0.0;
	CalcMat3.m_afEntry[8] = (Real)1.0;
	return Matrix3<Real>(CalcMat3);
}
//----------------------------------------------------------------------------
template <class Real>
Matrix3<Real> Matrix3<Real>::RotationWithQuaternion(Quaternion<Real> &pRotQuat )
{
	...
	CalcMat3.m_afEntry[0] = (Real)1.0 - (yy + zz);
	CalcMat3.m_afEntry[1] = xy - wz;
	CalcMat3.m_afEntry[2] = xz + wy;
	
	CalcMat3.m_afEntry[3] = xy + wz;
	CalcMat3.m_afEntry[4] = (Real)1.0 - (xx + zz);
	CalcMat3.m_afEntry[5] = yz - wx;
	
	CalcMat3.m_afEntry[6] = xz - wy;
	CalcMat3.m_afEntry[7] = yz + wx;
	CalcMat3.m_afEntry[8] = (Real)1.0 - (xx + yy);
	return Matrix3<Real>(CalcMat3);

}
//----------------------------------------------------------------------------
template <class Real>
Matrix3<Real> Matrix3<Real>::Scaling(Vector3<Real> &pScale )
{
	Matrix3<Real> CalcMat3;
...
//----------------------------------------------------------------------------
template <class Real>
void Matrix3<Real>::SetRotation(Real &xRotAng,Real &yRotAng,Real &zRotAng)
{
	*this=Rotation(xRotAng,yRotAng,zRotAng);
}
//----------------------------------------------------------------------------
template <class Real>
void Matrix3<Real>::SetRotationX(Real &rkAngle )
{
	*this=RotationX(rkAngle);
}
//----------------------------------------------------------------------------
template <class Real>
void Matrix3<Real>::SetRotationY(Real &rkAngle )
{
	*this=RotationY(rkAngle);
}
//----------------------------------------------------------------------------
template <class Real>
void Matrix3<Real>::SetRotationZ(Real &rkAngle )
{
	*this=RotationZ(rkAngle);
}
//----------------------------------------------------------------------------
template <class Real>
void Matrix3<Real>::SetRotationWithQuaternion(Quaternion<Real> &pRotQuat )
{
	*this=RotationWithQuaternion(pRotQuat);
}
//----------------------------------------------------------------------------
template <class Real>
void Matrix3<Real>::SetScaling(Vector3<Real> &pScale)
{
	*this=Scaling(pScale);
}
//----------------------------------------------------------------------------
...
inline Matrix3x::operator const fixed* () const
{
    return m_afEntry;
}
//----------------------------------------------------------------------------

inline Matrix3x::operator fixed* ()
{
    return m_afEntry;
}
//----------------------------------------------------------------------------

inline const fixed* Matrix3x::operator[] (int iRow) const
{
    return &m_afEntry[3*iRow];
}
//----------------------------------------------------------------------------

inline fixed* Matrix3x::operator[] (int iRow)
{
    return &m_afEntry[3*iRow];
}
//----------------------------------------------------------------------------

inline fixed Matrix3x::operator() (int iRow, int iCol) const
{
    return m_afEntry[iCol+3*iRow];
}
//----------------------------------------------------------------------------

inline fixed& Matrix3x::operator() (int iRow, int iCol)
{
    return m_afEntry[iCol+3*iRow];
}
//----------------------------------------------------------------------------

inline Matrix3x& Matrix3x::operator= (const Matrix3x& rkM)
{
    m_afEntry[0] = rkM.m_afEntry[0];
    m_afEntry[1] = rkM.m_afEntry[1];
    m_afEntry[2] = rkM.m_afEntry[2];
...
inline Matrix3x Matrix3x::operator+ (const Matrix3x& rkM) const
{
    return Matrix3x(
        m_afEntry[0] + rkM.m_afEntry[0],
        m_afEntry[1] + rkM.m_afEntry[1],
...
inline Matrix3x Matrix3x::operator* (fixed fScalar) const
{
    return Matrix3x(
        fScalar*m_afEntry[0],
        fScalar*m_afEntry[1],
...
inline Matrix3x Matrix3x::operator- () const
{
    return Matrix3x(
        -m_afEntry[0],
        -m_afEntry[1],
...
inline Matrix3x& Matrix3x::operator*= (fixed fScalar)
{
    m_afEntry[0] *= fScalar;
    m_afEntry[1] *= fScalar;
    m_afEntry[2] *= fScalar;
...
inline Matrix3x& Matrix3x::operator/= (fixed fScalar)
{
    ...
    {
        m_afEntry[0] = Mathx::MAX_REAL;
        m_afEntry[1] = Mathx::MAX_REAL;
        m_afEntry[2] = Mathx::MAX_REAL;
        m_afEntry[3] = Mathx::MAX_REAL;
        m_afEntry[4] = Mathx::MAX_REAL;
        m_afEntry[5] = Mathx::MAX_REAL;
        m_afEntry[6] = Mathx::MAX_REAL;
        m_afEntry[7] = Mathx::MAX_REAL;
        m_afEntry[8] = Mathx::MAX_REAL;
    }
...
inline Vector3x Matrix3x::operator* (const Vector3x& rkV) const
{
    return Vector3x(
        m_afEntry[0]*rkV[0] + m_afEntry[1]*rkV[1] + m_afEntry[2]*rkV[2],
        m_afEntry[3]*rkV[0] + m_afEntry[4]*rkV[1] + m_afEntry[5]*rkV[2],
