...
{
    return (Real)fmod((Real)fX,(Real)fY);
}
//----------------------------------------------------------------------------
template <class Real>
...
{
    return Math<Real>::INV_LN_2 * (Real)log((Real)fValue);
}
//----------------------------------------------------------------------------
template <class Real>
Real Math<Real>::Log10 (Real fValue)
{
    return Math<Real>::INV_LN_10 * (Real)log((Real)fValue);
}
//----------------------------------------------------------------------------
template <class Real>
...
Real Math<Real>::UnitRandom (unsigned int uiSeed)
{
    ...
    double dRatio = ((Real)rand())/((Real)(RAND_MAX));
    return (Real)dRatio;
}
//----------------------------------------------------------------------------
template <class Real>
