...
inline Matrix4x::operator const fixed* () const
{
    return m_afEntry;
}
//----------------------------------------------------------------------------

inline Matrix4x::operator fixed* ()
{
    return m_afEntry;
}
//----------------------------------------------------------------------------

inline const fixed* Matrix4x::operator[] (int iRow) const
{
    return &m_afEntry[4*iRow];
}
//----------------------------------------------------------------------------

inline fixed* Matrix4x::operator[] (int iRow)
{
    return &m_afEntry[4*iRow];
}
//----------------------------------------------------------------------------

inline fixed Matrix4x::operator() (int iRow, int iCol) const
{
    return m_afEntry[iCol+4*iRow];
}
//----------------------------------------------------------------------------

inline fixed& Matrix4x::operator() (int iRow, int iCol)
{
    return m_afEntry[iCol+4*iRow];
}
//----------------------------------------------------------------------------

inline Matrix4x& Matrix4x::operator= (const Matrix4x& rkM)
{
    m_afEntry[ 0] = rkM.m_afEntry[ 0];
    m_afEntry[ 1] = rkM.m_afEntry[ 1];
    m_afEntry[ 2] = rkM.m_afEntry[ 2];
...
inline Matrix4x Matrix4x::operator+ (const Matrix4x& rkM) const
{
    return Matrix4x(
        m_afEntry[ 0] + rkM.m_afEntry[ 0],
        m_afEntry[ 1] + rkM.m_afEntry[ 1],
...
inline Matrix4x Matrix4x::operator* (fixed fScalar) const
{
    return Matrix4x(
        fScalar*m_afEntry[ 0],
        fScalar*m_afEntry[ 1],
...
inline Matrix4x Matrix4x::operator- () const
{
    return Matrix4x(
        -m_afEntry[ 0],
        -m_afEntry[ 1],
...
inline Matrix4x& Matrix4x::operator*= (fixed fScalar)
{
    m_afEntry[ 0] *= fScalar;
    m_afEntry[ 1] *= fScalar;
    m_afEntry[ 2] *= fScalar;
...
inline Matrix4x& Matrix4x::operator/= (fixed fScalar)
{
    ...
    else
    {
        ...
        m_afEntry[ 9] = Mathx::MAX_REAL;
        m_afEntry[10] = Mathx::MAX_REAL;
        m_afEntry[11] = Mathx::MAX_REAL;
        m_afEntry[12] = Mathx::MAX_REAL;
        m_afEntry[13] = Mathx::MAX_REAL;
        m_afEntry[14] = Mathx::MAX_REAL;
        m_afEntry[15] = Mathx::MAX_REAL;
    }
...
inline Vector4x Matrix4x::operator* (const Vector4x& rkV) const
{
    return Vector4x(
        m_afEntry[ 0]*rkV[0] +
        m_afEntry[ 1]*rkV[1] +
