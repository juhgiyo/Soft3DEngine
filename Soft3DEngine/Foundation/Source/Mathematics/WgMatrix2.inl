...
inline Matrix2x::operator const fixed* () const
{
    return m_afEntry;
}
//----------------------------------------------------------------------------

inline Matrix2x::operator fixed* ()
{
    return m_afEntry;
}
//----------------------------------------------------------------------------

inline const fixed* Matrix2x::operator[] (int iRow) const
{
    return &m_afEntry[2*iRow];
}
//----------------------------------------------------------------------------

inline fixed* Matrix2x::operator[] (int iRow)
{
    return &m_afEntry[2*iRow];
}
//----------------------------------------------------------------------------

inline fixed Matrix2x::operator() (int iRow, int iCol) const
{
    return m_afEntry[iCol + 2*iRow];
}
//----------------------------------------------------------------------------

inline fixed& Matrix2x::operator() (int iRow, int iCol)
{
    return m_afEntry[iCol + 2*iRow];
}
//----------------------------------------------------------------------------

inline Matrix2x& Matrix2x::operator= (const Matrix2x& rkM)
{
    m_afEntry[0] = rkM.m_afEntry[0];
    m_afEntry[1] = rkM.m_afEntry[1];
    m_afEntry[2] = rkM.m_afEntry[2];
...
inline Matrix2x Matrix2x::operator+ (const Matrix2x& rkM) const
{
    return Matrix2x(
        m_afEntry[0] + rkM.m_afEntry[0],
        m_afEntry[1] + rkM.m_afEntry[1],
...
inline Matrix2x Matrix2x::operator* (fixed fScalar) const
{
    return Matrix2x(
        fScalar*m_afEntry[0],
        fScalar*m_afEntry[1],
...
inline Matrix2x Matrix2x::operator- () const
{
    return Matrix2x(
        -m_afEntry[0],
        -m_afEntry[1],
...
inline Matrix2x& Matrix2x::operator*= (fixed fScalar)
{
    m_afEntry[0] *= fScalar;
    m_afEntry[1] *= fScalar;
    m_afEntry[2] *= fScalar;
...
inline Vector2x Matrix2x::operator* (const Vector2x& rkV) const
{
    return Vector2x(
        m_afEntry[0]*rkV[0] + m_afEntry[1]*rkV[1],
        m_afEntry[2]*rkV[0] + m_afEntry[3]*rkV[1]);
