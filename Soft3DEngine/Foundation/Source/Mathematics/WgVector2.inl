...
inline Vector2x::operator const fixed* () const
{
    return m_afTuple;
}
//----------------------------------------------------------------------------

inline Vector2x::operator fixed* ()
{
    return m_afTuple;
}
//----------------------------------------------------------------------------

inline fixed Vector2x::operator[] (int i) const
{
    return m_afTuple[i];
}
//----------------------------------------------------------------------------

inline fixed& Vector2x::operator[] (int i)
{
    return m_afTuple[i];
}
//----------------------------------------------------------------------------

inline fixed Vector2x::X () const
{
    return m_afTuple[0];
}
//----------------------------------------------------------------------------

inline fixed& Vector2x::X ()
{
    return m_afTuple[0];
}
//----------------------------------------------------------------------------

inline fixed Vector2x::Y () const
{
    return m_afTuple[1];
}
//----------------------------------------------------------------------------

inline fixed& Vector2x::Y ()
{
    return m_afTuple[1];
}
//----------------------------------------------------------------------------

inline Vector2x& Vector2x::operator= (const Vector2x& rkV)
{
    m_afTuple[0] = rkV.m_afTuple[0];
    m_afTuple[1] = rkV.m_afTuple[1];
    return *this;
...
inline Vector2x Vector2x::operator+ (const Vector2x& rkV) const
{
    return Vector2x(
        m_afTuple[0]+rkV.m_afTuple[0],
        m_afTuple[1]+rkV.m_afTuple[1]);
...
inline Vector2x Vector2x::operator* (fixed fScalar) const
{
    return Vector2x(
        fScalar*m_afTuple[0],
        fScalar*m_afTuple[1]);
...
inline Vector2x Vector2x::operator- () const
{
    return Vector2x(
        -m_afTuple[0],
        -m_afTuple[1]);
...
inline Vector2x& Vector2x::operator*= (fixed fScalar)
{
    m_afTuple[0] *= fScalar;
    m_afTuple[1] *= fScalar;
    return *this;
...
inline fixed Vector2x::Length () const
{
    return Mathx::Sqrt(
        m_afTuple[0]*m_afTuple[0] +
        m_afTuple[1]*m_afTuple[1]);
...
inline fixed Vector2x::SquaredLength () const
{
    return
        m_afTuple[0]*m_afTuple[0] +
        m_afTuple[1]*m_afTuple[1];
...
inline fixed Vector2x::Dot (const Vector2x& rkV) const
{
    return
        m_afTuple[0]*rkV.m_afTuple[0] +
        m_afTuple[1]*rkV.m_afTuple[1];
...
inline fixed Vector2x::Normalize ()
{
...
inline Vector2x Vector2x::Perp () const
{
    return Vector2x(m_afTuple[1],-m_afTuple[0]);
}
//----------------------------------------------------------------------------

inline Vector2x Vector2x::UnitPerp () const
{
    Vector2x kPerp(m_afTuple[1],-m_afTuple[0]);
    kPerp.Normalize();
    return kPerp;
}
//----------------------------------------------------------------------------

inline fixed Vector2x::DotPerp (const Vector2x& rkV) const
{
    return m_afTuple[0]*rkV.m_afTuple[1] - m_afTuple[1]*rkV.m_afTuple[0];
}
//----------------------------------------------------------------------------

inline Vector2x operator* (fixed fScalar, const Vector2x& rkV)
{
    return Vector2x(
        fScalar*rkV[0],
        fScalar*rkV[1]);
