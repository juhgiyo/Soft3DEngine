...
inline Vector3x::operator const fixed* () const
{
    return m_afTuple;
}
//----------------------------------------------------------------------------

inline Vector3x::operator fixed* ()
{
    return m_afTuple;
}
//----------------------------------------------------------------------------

inline fixed Vector3x::operator[] (int i) const
{
    return m_afTuple[i];
}
//----------------------------------------------------------------------------

inline fixed& Vector3x::operator[] (int i)
{
    return m_afTuple[i];
}
//----------------------------------------------------------------------------

inline fixed Vector3x::X () const
{
    return m_afTuple[0];
}
//----------------------------------------------------------------------------

inline fixed& Vector3x::X ()
{
    return m_afTuple[0];
}
//----------------------------------------------------------------------------

inline fixed Vector3x::Y () const
{
    return m_afTuple[1];
}
//----------------------------------------------------------------------------

inline fixed& Vector3x::Y ()
{
    return m_afTuple[1];
}
//----------------------------------------------------------------------------

inline fixed Vector3x::Z () const
{
    return m_afTuple[2];
}
//----------------------------------------------------------------------------

inline fixed& Vector3x::Z ()
{
    return m_afTuple[2];
}
//----------------------------------------------------------------------------

inline Vector3x& Vector3x::operator= (const Vector3x& rkV)
{
    m_afTuple[0] = rkV.m_afTuple[0];
    m_afTuple[1] = rkV.m_afTuple[1];
    m_afTuple[2] = rkV.m_afTuple[2];
...
inline Vector3x Vector3x::operator+ (const Vector3x& rkV) const
{
    return Vector3x(
        m_afTuple[0]+rkV.m_afTuple[0],
        m_afTuple[1]+rkV.m_afTuple[1],
...
inline Vector3x Vector3x::operator* (fixed fScalar) const
{
    return Vector3x(
        fScalar*m_afTuple[0],
        fScalar*m_afTuple[1],
...
inline Vector3x Vector3x::operator- () const
{
    return Vector3x(
        -m_afTuple[0],
        -m_afTuple[1],
...
inline Vector3x& Vector3x::operator*= (fixed fScalar)
{
    m_afTuple[0] *= fScalar;
    m_afTuple[1] *= fScalar;
    m_afTuple[2] *= fScalar;
...
inline fixed Vector3x::Length () const
{
    return fixed(FixedFromFloat(Mathf::Sqrt(
        FloatFromFixed(m_afTuple[0])*FloatFromFixed(m_afTuple[0]) +
        FloatFromFixed(m_afTuple[1])*FloatFromFixed(m_afTuple[1]) +
        FloatFromFixed(m_afTuple[2])*FloatFromFixed(m_afTuple[2]))));
}
//----------------------------------------------------------------------------

inline fixed Vector3x::SquaredLength () const
{
    return
        m_afTuple[0]*m_afTuple[0] +
        m_afTuple[1]*m_afTuple[1] +
...
inline fixed Vector3x::Dot (const Vector3x& rkV) const
{
    return
        m_afTuple[0]*rkV.m_afTuple[0] +
        m_afTuple[1]*rkV.m_afTuple[1] +
...
//----------------------------------------------------------------------------
inline fixed Vector3x::Normalize ()
{
...
inline Vector3x Vector3x::Cross (const Vector3x& rkV) const
{
    return Vector3x(
        m_afTuple[1]*rkV.m_afTuple[2] - m_afTuple[2]*rkV.m_afTuple[1],
        m_afTuple[2]*rkV.m_afTuple[0] - m_afTuple[0]*rkV.m_afTuple[2],
...
inline Vector3x Vector3x::UnitCross (const Vector3x& rkV) const
{
    Vector3x kCross(
        m_afTuple[1]*rkV.m_afTuple[2] - m_afTuple[2]*rkV.m_afTuple[1],
        m_afTuple[2]*rkV.m_afTuple[0] - m_afTuple[0]*rkV.m_afTuple[2],
...
inline Vector3x operator* (fixed fScalar, const Vector3x& rkV)
{
    return Vector3x(
        fScalar*rkV[0],
        fScalar*rkV[1],
